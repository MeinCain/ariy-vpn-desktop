...
## Откровение: что это и для кого

Перед тобой **священный клиент сервиса [Ariy VPN](https://example.com/)** под
Windows. Если ты — благословенный подписчик, снизойди на страницу
[Releases](https://github.com/MeinCain/ariy-vpn-desktop/releases), забери
свежий installer, запусти, войди через Telegram или email — и подписка
сама явится тебе во всей славе. Никаких ссылок копировать не надо: всё
открывается одним мановением.

Если ты **не наш подписчик** — этот installer тебе не подойдёт: он
сакрально привязан к `api.example.com` (обряд аутентификации) и
`cabinet.example.com` (личный храм пользователя). Но проект **MIT-благ** —
ты можешь форкнуть исходники и собрать **свой божественный клиент** для
своего VPN-сервиса (см. раздел
[«Как воздвигнуть свой собственный храм»](#как-воздвигнуть-свой-собственный-храм)
ниже).

Сей труд — **божественный форк** замечательного клиента
...
server-driven UX) — его благословение. Низкий поклон автору. Мы приняли
эту благодать и обвенчали её с auth-инфраструктурой Ariy VPN.
